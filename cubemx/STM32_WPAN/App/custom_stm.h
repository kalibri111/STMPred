...
typedef enum {
    ...
    /* DataService */
    CUSTOM_STM_VLT_CHR,
    CUSTOM_STM_DBG_A_CHR,
} Custom_STM_Char_Opcode_t;

typedef enum {
    /* OnCharachteristic */
    CUSTOM_STM_ON_CHR_READ_EVT,
    CUSTOM_STM_ON_CHR_WRITE_EVT,
    /* OfCharacteristic */
    CUSTOM_STM_OF_CHR_READ_EVT,
    CUSTOM_STM_OF_CHR_WRITE_EVT,
    /* ViolationCountCharacteristic */
    CUSTOM_STM_VLT_CHR_READ_EVT,
    /* DebugAxisService */
    CUSTOM_STM_DBG_A_CHR_READ_EVT,
    CUSTOM_STM_DBG_A_CHR_NOTIFY_ENABLED_EVT,
    CUSTOM_STM_DBG_A_CHR_NOTIFY_DISABLED_EVT,
